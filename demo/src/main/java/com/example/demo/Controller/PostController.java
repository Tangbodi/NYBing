...
//        myTableService.savePostData(input);
//    }
//    @GetMapping("gethtml/{postId}")
//    public String getHTML(@PathVariable String postId){
//        return myTableService.getPostData(postId);
//    }
    @GetMapping("/categories/{categoryId}/{postId}")
    public PostDTO findPostByPostId(HttpServletRequest request,@PathVariable("categoryId")Integer categoryId,@PathVariable("postId") String postId){
