...
//                        String textjson = "";
//                        String userId = "4028098187a09a9e0187a09ab2490000";
//                        SimpleDateFormat dateFormat = new SimpleDateFormat("yyyy/MM/dd");
//                        java.util.Date parsedDate = dateFormat.parse(date);
//                        Timestamp postDate = new java.sql.Timestamp(parsedDate.getTime());
//                        PreparedStatement preparedStatement = connection.prepareStatement("INSERT INTO posts (" + "postId," + "categoryId," + "title," + "textjson," + "textrender," + "publishAt," + "userName," + "userId)" + "VALUES (?, ?, ?, ?, ?, ?, ?, ?)");
