...
public class EmailValidationService {
    ...
    public boolean processEmailValidation(HttpServletRequest request, User user){
    ...
    public boolean sendEmailValidationLink(String recipientEmail,String emailValidationLink) throws MessagingException, UnsupportedEncodingException {
        try{
            ...
            mimeMessageHelper.setFrom("admin@junebabee.com","NYBing Support");
            ...
            String content = "<p>Hello,</p>"
                    ...
                    + "<p><a href=\"" + emailValidationLink + "\">Verify email address</a></p>"
                    + "<br>"
                    + "<p>Welcome to NYBing! "
                    + "The NYBing Team</p>";
